...
function Profile() {
  ...
  return (
    <div className="h-screen flex flex-col items-center w-screen  gap-3">
      <Navbar />
      <div className="w-[60%] mt-[50px] flex gap-10 p-[30px] border border-gray-800 rounded-2xl items-center hover:shadow-2xl hover:shadow-gray-900 transition-all ease-in-out duration-700">
        <div className="">
          <img
